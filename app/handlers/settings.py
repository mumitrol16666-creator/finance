...
def _s(lang: str, key: str, **kwargs) -> str:
    ...
    data = {
        "ru": {
            ...
            "time_title":"⏰ <b>Время ежедневного отчёта</b>\n\nУкажи время, когда бот должен отправлять итог дня.", "time_example":"Пример: <code>21:00</code>", "time_err":"Не похоже на время. Пример: <code>21:00</code>",
        ...
        "en": {
            ...
            "time_title":"⏰ <b>Daily report time</b>\n\nSpecify when the bot should send the daily summary.", "time_example":"Example: <code>21:00</code>", "time_err":"That doesn't look like a time. Example: <code>21:00</code>",
        ...
        "kk": {
            ...
            "time_title":"⏰ <b>Күндік есеп уақыты</b>\n\nБот күн қорытындысын қай уақытта жіберуі керек екенін көрсетіңіз.", "time_example":"Мысал: <code>21:00</code>", "time_err":"Уақыт түсінілмеді. Мысал: <code>21:00</code>",
